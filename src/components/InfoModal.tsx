  ...
  const content = {
    ...
    research: {
      ...
      items: [
        ...
        { icon: '👁', el: 'Η προσοχή μεταμορφώνει τη δομή. Η εστιασμένη προσοχή εμπλέκει τον προμετωπιαίο φλοιό — κεντρικό για την αυτορρύθμιση και την ικανότητα «επιστροφής» — και, με την πρακτική, μπορεί να τον ενισχύσει.', en: 'Attention builds structure. Focused attention engages the prefrontal cortex — central to self-regulation — and, with practice, may strengthen it.' },
        { icon: '🌊', el: 'Η ενσυνειδητότητα ρυθμίζει τον «αυτόματο πιλότο». Η πρακτική μειώνει τη δραστηριότητα του Default Mode Network — ένα δίκτυο που συνδέεται με τη νοητική περιπλάνηση.', en: 'Practice regulates the "autopilot". It reduces activity in the Default Mode Network — a network linked to rumination and mind-wandering.' },
