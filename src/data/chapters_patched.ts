...
export const CHAPTERS_DATA: Record<string, Chapter[]> = {
  en: [
    ...
    {num:2,title:"Breath / Air",sub:"The Energy of the Present Self",tag:"Energy",color:"var(--color-axis-breath)",hex:"#C07050",icon:"🫁",
     video:"/Basic.mp4",
     summary:"The breath is the element of Air, connecting us with the continuous rhythm of life and teaching the acceptance of transience.",
    ...
    {num:4,title:"Space / Water",sub:"Open Awareness",tag:"Opening",color:"var(--color-axis-space)",hex:"#B5A7D0",icon:"🌌",
     video:"/Basic.mp4",
     summary:"Space is the element of Water — the open, boundless field in which all experience arises. We learn to rest in awareness without resistance.",
     theorySections:[
