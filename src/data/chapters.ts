...
export const CHAPTERS_DATA: Record<string, Chapter[]> = {
  en: [
    ...
    {num:4,title:"Space / Water",sub:"The Infinite Cosmic Ocean",tag:"Opening",color:"var(--color-axis-space)",hex:"#B5A7D0",icon:"🌌",
     ...
     theorySections:[
       {title:"The Antidote to Overload",paragraphs: ["Open Attention{{open_awareness}} is the most powerful tool against overload. The opening of attention acts as a safety signal in the brain: 'there is no danger, there is space'.", "Peripheral vision{{peripheral_vision}}, open hearing, the sense of space around — all these together 'turn off' the alarm signal."]},
    ...
    {num:5,title:"Neurodivergent Mind",sub:"Running and Locking",tag:"Focusing",color:"var(--teal-med)",hex:"#2E8B9A",icon:"🧠",
     ...
     theorySections:[
       {title:"Your Mind is Not Broken",paragraphs: ["The neurodivergent mind is not defective — it functions differently. Intensity, distraction, locking are not weaknesses — they are patterns. And patterns can be recognized."], interactive: "racing_mind"},
       ...
       {title:"The Role of the Mechanical Mind",paragraphs: ["Many neurodivergent individuals develop a 'mechanical mind'{{mechanical_mind}} — an internal system of rules that replaces the missing automation. This is exhausting but brilliant.", "Mindfulness does not replace the mechanical mind — it relieves it. It provides moments of rest to the system."]},
