  ...
  en: [
    {num:1,title:"Body / Earth",sub:"The Stability of 'Here'",tag:"Here",color:"var(--color-axis-body)",hex:"#7A9E7E",icon:"⛰️",
     ...
     theorySections:[
       ...
       {title:"Grounding as a Somatic Anchor",paragraphs: ["The Default Mode Network — the 'autopilot' — produces mental wandering, self-criticism, and repetition of old stories. Every time you feel gravity and your feet on the floor, you restore your physical sensation and activate your proprioceptive center.", "While the DMN does not completely stop with gravity alone—that requires hyperfocus and open awareness—grounding serves as the vital first anchor to bring the mind back to the present."]},
       ...
       {title:"Escape from Concepts",paragraphs: ["Inside the body there are no concepts — only sensations. Weight, warmth, pressure, pulse. When you turn to the body, you step out of thought without fighting thought.", "This transition — from words to sensations — is the foundation of every mindfulness practice."]},
       {title:"The Body, Space, and the Sense of Safety",paragraphs: ["Deep relaxation within the body is never an isolated act. It always presupposes awareness of space. Our body, through sensory organs, constantly informs us about our position in space.", "When space is perceived as safe, the nervous system relaxes — and only then does the body truly let go."]}
     ],
    ...
    {num:2,title:"Breath / Sky",sub:"The Energy of the Present Self",tag:"Energy",color:"var(--color-axis-breath)",hex:"#C07050",icon:"🫁",
     ...
     theorySections:[
       ...
       {title:"Regulation in Intense Anxiety",paragraphs: ["In moments of intense anxiety, we let the exhale come out through the mouth, slightly slower and more prolonged. The slow exhale activates the vagus nerve — the 'brake' of the nervous system."]}
     ],
    ...
    {num:3,title:"Attention / Fire",sub:"The Fire of Consciousness",tag:"Direction",color:"var(--color-axis-focus)",hex:"#C8922A",icon:"🔥",
     ...
     theorySections:[
       ...
       {title:"The Power of Labeling",paragraphs: ["When a thought pulls you, label it: 'Worry', 'Scenario', 'Criticism'. The label creates distance — you are not the thought, you are the one observing it. Then gently return to the axis."]}
     ],
    ...
    {num:4,title:"Space / Water",sub:"The Infinite Cosmic Ocean",tag:"Opening",color:"var(--color-axis-space)",hex:"#B5A7D0",icon:"🌌",
     ...
     theorySections:[
       ...
       {title:"The Sky and the Clouds",paragraphs: ["The space of the sky always remains open, just like the space of awareness (Maha Ati/Mahamudra). Thoughts, emotions, sensations — they are clouds. They come and go. You are the space that holds them."], interactive: "openawareness"}
     ],
    ...
    {num:5,title:"Neurodivergent Mind",sub:"Running and Locking",tag:"Focusing",color:"var(--teal-med)",hex:"#2E8B9A",icon:"🧠",
     ...
     theorySections:[{title:"Your Mind is Not Broken",paragraphs: ["The neurodivergent mind is not defective — it functions differently. Intensity, distraction, locking are not weaknesses — they are patterns. And patterns can be recognized."], interactive: "racing_mind"},{title:"A Mind that Runs",paragraphs: ["Scattered Attention / Overload. The world becomes a chain of small hooks — every stimulus grabs a piece of attention.", "Tool: Body (Grounding) + Breath (Rhythm). Gravity brings you 'here', rhythm brings you 'now'."]},{title:"A Mind that Locks",paragraphs: ["Anchored Attention / Hyperfocus. Like a tunnel of intense focus. Time disappears, the body is forgotten.", "Tool: Space (Release) + Attention (Return). Soften your gaze, feel the space around — it 'breaks' the tunnel."]},{title:"The Role of the Mechanical Mind",paragraphs: ["Many neurodivergent individuals develop a 'mechanical mind' — an internal system of rules that replaces the missing automation. This is exhausting but brilliant.", "Mindfulness does not replace the mechanical mind — it relieves it. It provides moments of rest to the system."]},{title:"Kindness as an Exit from the Autopilot",paragraphs: ["Self-criticism is not your truth — it is an echo. Words you heard, looks you received, expectations unmet. Your nervous system stored them, and now you reproduce the same criticism without even realizing it.", "Neuroscience shows: self-criticism activates the amygdala and cortisol — the same circuits as an external danger. Every time you judge yourself, the brain reacts as if under attack.", "The softness of this method is not accidental. It is the very attitude we need to keep towards ourselves. Growth here does not mean productivity — it means fulfilling unique potential, just as a flower blooms when it has suitable soil and space.", "Treat yourself as you would treat a struggling friend."]}],
    ...
    {num:8,title:"Cheat Sheet",sub:"The Practice of Presence",tag:"Application",color:"var(--teal-dark)",hex:"#1A5F6E",icon:"📋",
     ...
     exercise:{title:"The 4 Steps of Presence",steps:["BODY: Feel your weight. Notice tensions.","BREATH: How is your breath? Do one exhale through the mouth.","ATTENTION: Where is your attention? Return to a fixed point.","SPACE: Soften your gaze. Remember the sky — you are the space."]},
  ...
  el: [
    {num:1,title:'Σώμα / Γη',sub:'Η Σταθερότητα του «Εδώ»',tag:'Εδώ',color:'var(--color-axis-body)',hex:'#7A9E7E',icon:'⛰️',
     ...
     theorySections:[
       ...
       {title:'Το Σώμα, ο Χώρος και η Αίσθηση Ασφάλειας',paragraphs: [`Η βαθιά χαλαρότητα μέσα στο σώμα δεν είναι ποτέ μια απομονωμένη πράξη. Προϋποθέτει πάντα την επίγνωση του χώρου. Το σώμα μας, μέσω των αισθητηρίων οργάνων, μας πληροφορεί συνεχώς για τη θέση μας μέσα στον χώρο.`, `Όταν ο χώρος γίνεται αντιληπτός ως ασφαλής, το νευρικό σύστημα χαλαρεί — και μόνο τότε το σώμα αφήνεται πραγματικά.`]}
     ],
    ...
    {num:4,title:'Χώρος / Νερό',sub:'Ο Άπειρος Κοσμικός Ωκεανός',tag:'Άνοιγμα',color:'var(--color-axis-space)',hex:'#B5A7D0',icon:'🌌',
     ...
     theorySections:[
       {title:'Το Αντίδοτο στην Υπερφόρτωση',paragraphs: [`Η Ανοιχτή Προσοχή{{open_awareness}} είναι το πιο ισχυρό εργαλείο ενάντια στην υπερφόρτωση. Το άνοιγμα της προσοχής λειτουργεί ως σήμα ασφάλειας στον εγκέφαλο: «δεν υπάρχει κίνδυνος, υπάρχει χώρος».`, `Η περιφερειακή όραση{{peripheral_vision}}, η ανοιχτή ακοή, η αίσθηση του χώρου γύρω — όλα αυτά μαζί «σβήνουν» το σήμα συναγερμού.`]},
    ...
    {num:5,title:'Νευροδιαφορετικός Νους',sub:'Τρέξιμο & Αγκύλωση',tag:'Μοτίβα',color:'var(--gold-dark)',hex:'#B07B1E',icon:'🧠',
      ...
      theorySections:[
        {title:'Η Δυναμική του Νου: Ανάμεσα σε δύο Άκρα',paragraphs: [`Ο νους ενός νευροδιαφορετικού ανθρώπου σπάνια είναι στατικός. Συνήθως κινείται ανάμεσα σε δύο ακραίες καταστάσεις: <strong>«τρέχει»</strong> ή <strong>«κλειδώνει»</strong>. Η ενσυνειδητότητα δεν στοχεύει στο να σταματήσει αυτή την κίνηση, αλλά στο να σου δείξει πώς να στέκεσαι μέσα σε αυτές τις καταστάσεις χωρίς να χάνεσαι.`], interactive: "racing_mind"},
