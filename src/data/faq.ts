  ...
  1: {
    el: [
      ...
      },
      {
        ...
        a: 'Το Default Mode Network — ο «αυτόματος πιλότος» — παράγει νοητική περιπλάνηση, αυτοκριτική και επανάληψη παλιών ιστοριών. Κάθε φορά που νιώθεις τη βαρύτητα και τα πόδια σου στο πάτωμα, επαναφέρεις τη σωματική αίσθηση και ενεργοποιείς το ιδιοδεκτικό σου κέντρο. Αν και το DMN δεν παύει οριστικά μόνο με τη βαρύτητα – χρειάζεται υπερ-εστίαση και ανοιχτή επίγνωση βαθύτερα – η γείωση είναι το άμεσο άγκιστρο που μας συνδέει ξανά με το Τώρα, σπάζοντας τον φαύλο κύκλο της σκέψης.',
