export const informativeVideos = [
    {
      id: 'j1OOEwpLcDc', // Eckhart Tolle - Night Sky
      title: { en: "Micro-Meditation: The Infinity of Space", el: "Micro-Meditation: Η Απεραντότητα του Χώρου" },
      author: "Eckhart Tolle",
      category: { en: "Space & Emptiness", el: "Χώρος & Κενό" },
    ...
    {
      id: 'MJ6m5DOER-c',
      title: { en: "Eckhart Tolle: The Ocean of Pure Awareness", el: "Eckhart Tolle: Ο Ωκεανός της Καθαρής Επίγνωσης" },
      author: "Eckhart Tolle",
      category: { en: "Presence & Being", el: "Παρουσία & Οντότητα" },
      ...
      description: {
        ...
        el: {
          ...
          points: [
            ...
            { time: "07:03", title: "Η Εσωτερική Ζωντάνια (The Inner Body)", text: "Νιώσε την ενέργεια που διαπερνά κάθε κύτταρο του σώματός σου. Αυτή η εσωτερική αίσθηση λειτουργεί ως η 'άγκυρα' για το Τώρα." }
          ],
    ...
    {
      id: '7Qbat52NE98',
      title: { en: "Tai Chi Walking: Grounding Motion", el: "Tai Chi Walking: Η Κίνηση της Γείωσης" },
      author: "Master Gu",
      category: { en: "Grounding & Motion", el: "Γείωση & Κίνηση" },
      ...
      description: {
        ...
        el: {
          ...
          bridgeTime: 675,
          mantra: ["ΦΤΕΡΝΑ", "ΔΑΧΤΥΛΑ", "ΜΠΡΟΣΤΑ", "ΠΙΣΩ", "ΕΞΩ", "TAP"]
        }
      }
    },
    {
      id: 'no4x4ewf1dM',
      title: { en: "Plum Village: The 10 Mindful Movements", el: "Plum Village: Οι 10 Ενσυνείδητες Κινήσεις" },
      author: "Plum Village",
      category: { en: "Mindfulness & Motion", el: "Ενσυνειδητότητα & Κίνηση" },
    ...
    {
      id: 'HDoAuilRt3Q',
      title: { en: "Complete Breathing Experience", el: "Η Βιωματική Εμπειρία της Πλήρους Αναπνοής" },
      author: "Fabio Andrico",
      category: { en: "Breath & Presence", el: "Αναπνοή & Παρουσία" },
    ...
    {
      id: 'tmgHDEypPAQ',
      title: { en: "Open Focus: The Neuroscience of Diffuse Attention", el: "Open Focus: Η Νευροεπιστήμη της Διάχυτης Προσοχής" },
      author: "Dr. Les Fehmi",
      category: { en: "Neuroscience & Attention", el: "Νευροεπιστήμη & Προσοχή" },
      ...
      description: {
        en: {
          ...
          bridgeTime: 306,
          attentionStyles: [
            { id: 'narrow', name: 'Narrow Focus', time: '01:00', desc: 'Single object, excluding all else.' },
            { id: 'diffuse', name: 'Diffuse Focus', time: '02:21', desc: 'Including space, sounds, and sensations.' },
            { id: 'immersed', name: 'Immersed Focus', time: '02:29', desc: 'Full union with the experience (e.g., dance, a hug).' },
            { id: 'separate', name: 'Separate Focus', time: '02:54', desc: 'Observation from a distance, like an objective judge.' }
          ]
        },
        el: {
          ...
          bridgeTime: 306,
          attentionStyles: [
            { id: 'narrow', name: 'Στενή Προσοχή', time: '01:00', desc: 'Εστίαση σε ένα μόνο αντικείμενο, αποκλείοντας όλα τα άλλα.' },
            { id: 'diffuse', name: 'Διάχυτη Προσοχή', time: '02:21', desc: 'Συμπερίληψη του χώρου, των ήχων και των αισθήσεων γύρω μας.' },
            { id: 'immersed', name: 'Απορροφημένη Προσοχή', time: '02:29', desc: 'Πλήρης εμβάθυνση και ένωση με την εμπειρία (π.χ. χορός, μια αγκαλιά).' },
            { id: 'separate', name: 'Αποστασιοποιημένη Προσοχή', time: '02:54', desc: 'Παρατήρηση από απόσταση, σαν αντικειμενικός κριτής.' }
          ]
        }
      }
    },
    {
      id: 'i1z6L1IsZlg',
      title: { en: "Yantra Yoga: The 8 Movements", el: "Yantra Yoga: Οι 8 Κινήσεις" },
      author: "Chögyal Namkhai Norbu",
      category: { en: "Yoga & Energy", el: "Yoga & Ενέργεια" },
